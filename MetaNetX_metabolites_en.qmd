...
MetaNetX aggregates identifiers from **KEGG, ChEBI, HMDB, BiGG, SEED, VMH, MetaCyc, Rhea, SABIO-RK**, and groups them into **sets** based on :
...
The goal is to submit them to MetaNetX and observe how they are grouped. Use MetaNetX ID-mapper available at https://www.metanetx.org/map/ids.
